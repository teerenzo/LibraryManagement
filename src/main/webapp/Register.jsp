                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">(UR LIBRARY) Register to be able to issue books!</h1>
                            </div>
                            <form class="user">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    <input type="text" name="regnumber" class="form-control form-control-user" id="exampleInputEmail"
