        ...
        <div class="panel panel-info">
          ...
          <form action="AddStudent"  method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" required='' name="sname" placeholder="Enter Fullname">
                </div>
                <div class="form-group">
                    <label for="firstname">Registration Number:</label>
                    <input type="text" class="form-control" required='' name="regn" placeholder="EnterRegistration Number">
                </div>
                <div class="form-group">
